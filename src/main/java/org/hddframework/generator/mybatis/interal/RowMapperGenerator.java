 ...
 */
public class RowMapperGenerator extends GeneratorTemplate {

    private final String templateName = "RowMapper.ftl";
    private final String fileNameSuffix = "RowMapper.java";
    private final String modelPathName = "dao"+ File.separator + "mapper";

    public RowMapperGenerator(MBGConfiguration mbgConfiguration) {
