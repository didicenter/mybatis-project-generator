...
public class TimestampObjectSerializerGenerator extends GeneratorTemplate {

    private final String templateName = "TimestampObjectSerializer.ftl";
    private final String fileNameSuffix = "TimestampObjectSerializer.java";
    private final String modelPathName = "configuration/fastjson";

    public TimestampObjectSerializerGenerator(MBGConfiguration mbgConfiguration) {
