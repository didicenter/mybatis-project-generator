 ...
 */
public class DaoImplGenerator extends GeneratorTemplate {

    private final String templateName = "DaoImpl.ftl";
    private final String fileNameSuffix = "DaoImpl.java";
    private final String modelPathName = "dao" + File.separator + "impl";

    public DaoImplGenerator(MBGConfiguration mbgConfiguration) {
