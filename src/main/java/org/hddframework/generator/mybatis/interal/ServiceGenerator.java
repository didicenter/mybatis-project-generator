 ...
 */
public class ServiceGenerator extends GeneratorTemplate {

    private final String templateName = "Service.ftl";
    private final String fileNameSuffix = "Service.java";
    private final String modelPathName = "service";

    public ServiceGenerator(MBGConfiguration mbgConfiguration) {
