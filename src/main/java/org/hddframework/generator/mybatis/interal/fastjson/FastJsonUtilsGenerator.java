...
public class FastJsonUtilsGenerator extends GeneratorTemplate {

    private final String templateName = "FastJsonUtils.ftl";
    private final String fileNameSuffix = "FastJsonUtils.java";
    private final String modelPathName = "configuration/fastjson";

    public FastJsonUtilsGenerator(MBGConfiguration mbgConfiguration) {
