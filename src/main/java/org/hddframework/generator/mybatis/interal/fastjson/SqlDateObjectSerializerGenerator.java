...
public class SqlDateObjectSerializerGenerator extends GeneratorTemplate {

    private final String templateName = "SqlDateObjectSerializer.ftl";
    private final String fileNameSuffix = "SqlDateObjectSerializer.java";
    private final String modelPathName = "configuration/fastjson";

    public SqlDateObjectSerializerGenerator(MBGConfiguration mbgConfiguration) {
