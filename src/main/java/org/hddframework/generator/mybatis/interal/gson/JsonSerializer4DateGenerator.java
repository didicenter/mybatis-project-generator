...
public class JsonSerializer4DateGenerator extends GeneratorTemplate {

    private final String templateName = "JsonSerializer4Date.ftl";
    private final String fileNameSuffix = "JsonSerializer4Date.java";
    private final String modelPathName = "configuration/gson";

    public JsonSerializer4DateGenerator(MBGConfiguration mbgConfiguration) {
