 ...
 */
public class RedisCachingConfigurationGenerator extends GeneratorTemplate {

    private final String templateName = "RedisCachingConfiguration.ftl";
    private final String fileNameSuffix = "RedisCachingConfiguration.java";
    private final String modelPathName = "configuration";

    public RedisCachingConfigurationGenerator(MBGConfiguration mbgConfiguration) {
