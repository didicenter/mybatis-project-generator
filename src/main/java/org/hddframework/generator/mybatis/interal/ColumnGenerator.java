 ...
 */
public class ColumnGenerator extends FrameworkGenerator {

    private final String templateName = "Column.ftl";
    private final String fileNameSuffix = "Column.java";
    private final String modelPathName = "jdbc" + File.separator + "annotation";

    public ColumnGenerator(MBGConfiguration mbgConfiguration) {
