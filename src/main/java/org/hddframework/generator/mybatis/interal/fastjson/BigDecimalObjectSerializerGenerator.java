...
public class BigDecimalObjectSerializerGenerator extends GeneratorTemplate {

    private final String templateName = "BigDecimalObjectSerializer.ftl";
    private final String fileNameSuffix = "BigDecimalObjectSerializer.java";
    private final String modelPathName = "configuration/fastjson";

    public BigDecimalObjectSerializerGenerator(MBGConfiguration mbgConfiguration) {
