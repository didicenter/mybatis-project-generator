...
public class UtilDateObjectSerializerGenerator extends GeneratorTemplate {

    private final String templateName = "UtilDateObjectSerializer.ftl";
    private final String fileNameSuffix = "UtilDateObjectSerializer.java";
    private final String modelPathName = "configuration/fastjson";

    public UtilDateObjectSerializerGenerator(MBGConfiguration mbgConfiguration) {
