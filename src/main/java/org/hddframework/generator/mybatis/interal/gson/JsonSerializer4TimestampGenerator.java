...
public class JsonSerializer4TimestampGenerator extends GeneratorTemplate {

    private final String templateName = "JsonSerializer4Timestamp.ftl";
    private final String fileNameSuffix = "JsonSerializer4Timestamp.java";
    private final String modelPathName = "configuration/gson";

    public JsonSerializer4TimestampGenerator(MBGConfiguration mbgConfiguration) {
