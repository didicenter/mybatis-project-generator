 ...
 */
public class MapperGenerator extends GeneratorTemplate {

    private final String templateName = "Mapper.ftl";
    private final String fileNameSuffix = "Mapper.java";
    private final String modelPathName = "mapper";

    public MapperGenerator(MBGConfiguration mbgConfiguration) {
