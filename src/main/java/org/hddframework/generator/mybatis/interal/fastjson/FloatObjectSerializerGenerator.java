...
public class FloatObjectSerializerGenerator extends GeneratorTemplate {

    private final String templateName = "FloatObjectSerializer.ftl";
    private final String fileNameSuffix = "FloatObjectSerializer.java";
    private final String modelPathName = "configuration/fastjson";

    public FloatObjectSerializerGenerator(MBGConfiguration mbgConfiguration) {
