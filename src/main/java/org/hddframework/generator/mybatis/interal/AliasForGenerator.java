 ...
 */
public class AliasForGenerator extends FrameworkGenerator {

    private final String templateName = "AliasFor.ftl";
    private final String fileNameSuffix = "AliasFor.java";
    private final String modelPathName = "core";

    public AliasForGenerator(MBGConfiguration mbgConfiguration) {
