 ...
 */
public class ModelExampleGenerator extends GeneratorTemplate {

    private final String templateName = "ModelExample.ftl";
    private final String fileNameSuffix = "Example.java";
    private final String modelPathName = "model";

    public ModelExampleGenerator(MBGConfiguration mbgConfiguration) {
