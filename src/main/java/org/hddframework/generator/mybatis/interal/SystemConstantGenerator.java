 ...
 */
public class SystemConstantGenerator extends GeneratorTemplate {

    private final String templateName = "SystemConstant.ftl";
    private final String fileNameSuffix = "SystemConstant.java";
    private final String modelPathName = "configuration";

    public SystemConstantGenerator(MBGConfiguration mbgConfiguration) {
