 ...
 */
public abstract class FrameworkGenerator extends GeneratorTemplate {

    private final String pluginDirectoryPath = new String("org" + File.separator + "hddframework");

    public FrameworkGenerator(MBGConfiguration mbgConfiguration) {
