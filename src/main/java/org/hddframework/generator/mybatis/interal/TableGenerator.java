 ...
 */
public class TableGenerator extends FrameworkGenerator {

    private final String templateName = "Table.ftl";
    private final String fileNameSuffix = "Table.java";
    private final String modelPathName = "jdbc" + File.separator + "annotation";

    public TableGenerator(MBGConfiguration mbgConfiguration) {
