 ...
 */
public class ProjectPropertiesFileGenerator extends GeneratorTemplate {

    private final String templateName = "ProjectProperty.ftl";
    private final String fileNameSuffix = "application.properties";
    private final String modelPathName = "";

    public ProjectPropertiesFileGenerator(MBGConfiguration mbgConfiguration) {
        super(mbgConfiguration);
    }

    @Override
    protected File getDirectory() {
        String modelPath = (mbgConfiguration.getProjectConfiguration().getResourcesDirectory().getAbsolutePath() + File.separator + this.modelPathName)
