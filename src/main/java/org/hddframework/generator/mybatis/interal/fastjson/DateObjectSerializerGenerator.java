...
public class DateObjectSerializerGenerator extends GeneratorTemplate {

    private final String templateName = "DateObjectSerializer.ftl";
    private final String fileNameSuffix = "DateObjectSerializer.java";
    private final String modelPathName = "configuration/fastjson";

    public DateObjectSerializerGenerator(MBGConfiguration mbgConfiguration) {
