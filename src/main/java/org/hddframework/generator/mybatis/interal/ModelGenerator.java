 ...
 */
public class ModelGenerator extends GeneratorTemplate {

    private final String templateName = "Model.ftl";
    private final String fileNameSuffix = ".java";
    private final String modelPathName = "model";

    public ModelGenerator(MBGConfiguration mbgConfiguration) {
