...
public class GsonJsonUtilsGenerator extends GeneratorTemplate {

    private final String templateName = "GsonJsonUtils.ftl";
    private final String fileNameSuffix = "GsonJsonUtils.java";
    private final String modelPathName = "configuration/gson";

    public GsonJsonUtilsGenerator(MBGConfiguration mbgConfiguration) {
