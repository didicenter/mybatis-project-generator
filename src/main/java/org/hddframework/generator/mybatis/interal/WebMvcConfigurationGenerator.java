 ...
 */
public class WebMvcConfigurationGenerator extends GeneratorTemplate {

    private final String templateName = "WebMvcConfiguration.ftl";
    private final String fileNameSuffix = "WebMvcConfiguration.java";
    private final String modelPathName = "configuration";

    public WebMvcConfigurationGenerator(MBGConfiguration mbgConfiguration) {
