 ...
 */
public class ControllerGenerator extends GeneratorTemplate {

    private final String templateName = "Controller.ftl";
    private final String fileNameSuffix = "Controller.java";
    private final String modelPathName = "controller";

    public ControllerGenerator(MBGConfiguration mbgConfiguration) {
