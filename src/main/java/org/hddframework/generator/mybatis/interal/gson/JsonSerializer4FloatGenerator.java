...
public class JsonSerializer4FloatGenerator extends GeneratorTemplate {

    private final String templateName = "JsonSerializer4Float.ftl";
    private final String fileNameSuffix = "JsonSerializer4Float.java";
    private final String modelPathName = "configuration/gson";

    public JsonSerializer4FloatGenerator(MBGConfiguration mbgConfiguration) {
