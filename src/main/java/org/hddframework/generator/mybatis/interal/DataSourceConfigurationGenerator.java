 ...
 */
public class DataSourceConfigurationGenerator extends GeneratorTemplate {

    private final String templateName = "DataSourceConfiguration.ftl";
    private final String fileNameSuffix = "DataSourceConfiguration.java";
    private final String modelPathName = "configuration";

    public DataSourceConfigurationGenerator(MBGConfiguration mbgConfiguration) {
