 ...
 */
public class ExceptionHandlerConfigurationGenerator extends GeneratorTemplate {

    private final String templateName = "ExceptionHandlerConfiguration.ftl";
    private final String fileNameSuffix = "ExceptionHandlerConfiguration.java";
    private final String modelPathName = "configuration";

    public ExceptionHandlerConfigurationGenerator(MBGConfiguration mbgConfiguration) {
